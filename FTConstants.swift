...
struct FT {
    ...
    internal static let DefaultArrowCornerRadius = CGFloat(2)
    internal static let DefaultMenuArrowWidth = CGFloat(4)
    internal static let DefaultMenuArrowHeight = CGFloat(6)
    internal static let DefaultAnimationDuration = TimeInterval(0.2)
    internal static let DefaultBorderWidth = CGFloat(0)
