...
public class FTConfiguration: NSObject {
    ...
    public var textFont: UIFont = UIFont.sf_systemFont(ofSize: 14)
    ...
    public var cellAlaph: CGFloat = 1.0

    public var selectedTextColor: UIColor = UIColor.darkText
    public var selectedTextFont: UIFont = UIFont.sf_systemFont(ofSize: 14)
